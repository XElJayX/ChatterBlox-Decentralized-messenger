...
const FriendRequests = () => {
  ...
  return (
    <div className={Style.friend_requests_wrapper}>
      ...
      {filteredRequests.map((request) => (
        <li key={request.sender} className={Style.friend_request_item}> {/* Apply the CSS class */}
          <div className={Style.friend_request_info}> {/* Apply the CSS class */}
            <p className={Style.friend_request_message}>Jayanth wants to be your friend!</p>
            <div className={Style.friend_request_actions}> {/* Apply the CSS class */}
              ...
              <Image src= {images.ignore} alt="Ignore" width={50} height={50} onClick={()=> handleIgnore(request.sender)} className={Style.ignore_image}/>
            </div>
          </div>
        </li>
      ))}
